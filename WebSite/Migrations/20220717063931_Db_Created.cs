    ...
    public partial class Db_Created : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAdditionalInfo", x => x.UserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendUsers", x => new { x.FriendRequestId, x.UserId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FriendUsers_FriendRequests_FriendRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostLikes_AspNetUsers_LikerId",
                        column: x => x.LikerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bios", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_Bios_UserAdditionalInfo_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoverImages", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_CoverImages_UserAdditionalInfo_UserId",
                        column: x => x.UserId,
                        principalTable: "UserAdditionalInfo",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfileImages_UserAdditionalInfo_UserId",
                        column: x => x.UserId,
                        principalTable: "UserAdditionalInfo",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
